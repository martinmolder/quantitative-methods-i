...
Run the same `install_course_url()` line again whenever a new version is posted. It overwrites what you have, and your progress through the lessons is kept separately, so you do not lose it.
