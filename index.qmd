...
Everything the course uses is here. These links are permanent, so you can point a script at one instead of downloading it by hand --- [session 2](02-data-management-1.qmd) shows how, and where the files belong once you have them.
...
| [`codebook.csv`](data/codebook.csv) | Every variable, what it is, and how it is coded. Also [as a table](02-data-management-1.qmd#appendix-what-the-variables-are). |
...
| [`Quantitative_Methods_I.zip`](data/Quantitative_Methods_I.zip) | The `swirl` lessons. You do not need to download this --- see below. |
...
[Session 1](01-r-and-rstudio.qmd) covers this in full, including what to do if your network blocks the download.
