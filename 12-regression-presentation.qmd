...
::: {.swirl}
**In the seminar.** `swirl` lesson 12, *Presenting regression results*. Building a table with several models, renaming and ordering coefficients, coefficient plots, and predicted values. Around 30 minutes.
:::
